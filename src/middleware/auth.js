...
export function signUser(user){ return jwt.sign({sub:user.id,email:user.email},process.env.JWT_SECRET||"AslKod-local-secret",{expiresIn:process.env.JWT_EXPIRES_IN||"7d"}); }
